  ...
  <div class="sidebar" :class="{ 'sidebar-collapsed': isCollapsed }">
    ...
    <div class="sidebar-content">
      <div class="logo-wrapper">
        <!-- 收起时显示的logo -->
        <div class="logo-container collapsed-logo" v-show="isCollapsed">
          <svg viewBox="0 0 30 30" class="logo-svg">
            <path
              id="path"
        ...
        <!-- 展开时显示的内容 -->
        <div class="expanded-content" v-show="!isCollapsed">
          <div class="system-status-wrapper">
            <SystemStatus :enabled="!isCollapsed" v-if="!isCollapsed" />
          </div>
        </div>
      </div>
